<template>
    <div>
        <v-card class="mx-auto"  max-width="650"  variant="flat">
            <v-sheet >
                <v-card-item>
            ...
            <v-card class="ma-4"  rounded="lg" variant="flat">
                <v-card-item>
                    <v-card-title class="text-body-2 d-flex align-center">
                        <v-icon  icon="mdi-step-forward" start></v-icon>
...
import { apiCheckCode, apiForgetPassword, apiGetCode } from '@/api/user/auth';
import buildUtils from '@/util/buildUtil';
